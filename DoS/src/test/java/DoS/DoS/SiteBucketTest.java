...
public class SiteBucketTest {
	...
	public void testDuplicateSites() {
		...
		assertNotNull("Verify that a non-empty pending queue can call run_next_job()", sb1.poll());
	...
	public void testCount() {
		...
		assertNotNull("Verify that a non-empty pending queue can call run_next_job()", sb.poll());
	...
	public void testPriorityOrder() {
		...
		for (int priority=10; priority>0; --priority) {
			...
			assertNotNull("Run next job", sb.poll());
	...
	public void testCompareTo() {
		...
		assertNotNull("Able to schedule for site_bucket 2", sb2.poll());
	...
	public void testEquals() {
		...
		assertNotNull("Run job", sb1.poll());
	...
	public void testClear() {
		...
		assertNotNull("Can run next job", sb.poll());
		...
		assertNull("Can not schedule another job", sb.poll());
	}
}
